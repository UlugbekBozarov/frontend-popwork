    ...
    const [s5] = useState([
        {
            ...
            carousel: [
                {
                    brandImg: "/images/section-5/1/brand_s11.png",
                    position: "Executive",
                ...
                },
                {
                    ...
                    useImg: "/images/section-5/1/user_s14.png"
                }
            ]
        },
        {
            ...
            carousel: [
                {
                    brandImg: "/images/section-5/2/brand_s21.png",
                    position: "Manager",
                    description: "Clear, simple and efficient.",
                    fullName: "Grégoire Tayeau",
                    useImg: "/images/section-5/2/user_s21.png"
                },
                {
                    brandImg: "/images/section-5/2/brand_s22.png",
                    ...
                    useImg: "/images/section-5/2/user_s22.png"
                },
                {
                    brandImg: "/images/section-5/2/brand_s23.png",
                    position: "Team member",
                    description: "Popwork helps me prioritize my work every week.",
                    fullName: "Marie-Louise Nielsen",
                    useImg: "/images/section-5/2/user_s23.png"
                }
            ]
        },
        {
            ...
            carousel: [
                {
                    brandImg: "/images/section-5/3/brand_s31.png",
                    position: "Manager",
                    ...
                    useImg: "/images/section-5/3/user_s31.png"
                },
                {
                    brandImg: "/images/section-5/3/brand_s32.png",
                    position: "Manager",
                    ...
                    useImg: "/images/section-5/3/user_s32.png"
                },
                {
                    brandImg: "/images/section-5/3/brand_s33.png",
                    position: "Executive",
                    description: "Popwork helps me structure the topics of my team; I save time every week !",
                    fullName: "Nelson Burton",
                    useImg: "/images/section-5/3/user_s33.png"
                },
                {
                    brandImg: "/images/section-5/3/brand_s34.png",
                    position: "Executive",
                    ...
                    useImg: "/images/section-5/3/user_s34.png"
                }
            ]
        }
    ])
